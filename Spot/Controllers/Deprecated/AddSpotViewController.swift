...
class AddSpotViewController: UIViewController, UITextViewDelegate, UITextFieldDelegate {
    ...
    var tagScroll = UICollectionView(frame: CGRect.zero, collectionViewLayout: UICollectionViewFlowLayout())
    var tagLayout: UICollectionViewFlowLayout = UICollectionViewFlowLayout()
    ...
    func setUpFields() {
        ...
        tagScroll = UICollectionView(frame: CGRect.zero, collectionViewLayout: UICollectionViewFlowLayout())
